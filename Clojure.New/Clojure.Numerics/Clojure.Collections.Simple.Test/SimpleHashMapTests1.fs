...
let basicSimpleHashMapCreateTests =
    testList "Basic SimpleHashMap create tests" [
...
let basicSimpleHashMapAssocTests =
    testList "Basic SimpleHashMap Assoc tests" [
...
let basicSimpleHashMapPersistentCollectionTests =
    testList "Basic SimpleHashMap PersistentCollection tests" [
...
let basicSimpleHashMapPersistentMapTests =
    testList "Basic SimpleHashMap tests" [
...
let aPersistentMapTests =
    testList "APersistentMap tests for SimpleHashMap" [
        ...
        testCase "cons on SimpleHashMap adds/repalces many" <| fun _ ->
...
[<Tests>]
let collisionTests = 
    testList "SimpleHashMap collision tests" [
        testCase "Collisions n m" <| fun _ ->
...
let bigPersistentHashMapTests =
    ftestList "big insertions into PersistentHashMap" [
        
            testCase "test for 100" <| fun _ ->
                doBigTest 100   

            testCase "test for 1000" <| fun _ ->
                doBigTest 1000   

            testCase "test for 2000" <| fun _ ->
                doBigTest 2000   

            testCase "test for 3000" <| fun _ ->
                doBigTest 3000   

            testCase "test for 4000" <| fun _ ->
                doBigTest 4000   

            testCase "test for 5000" <| fun _ ->
                doBigTest 5000   

            testCase "test for 6000" <| fun _ ->
                doBigTest 6000   

            testCase "test for 7000" <| fun _ ->
                doBigTest 7000   

            testCase "test for 8000" <| fun _ ->
                doBigTest 8000   

            testCase "test for 9000" <| fun _ ->
                doBigTest 9000   

            testCase "test for 10000" <| fun _ ->
                doBigTest 10000  
                
            testCase "test for 20000" <| fun _ ->
                doBigTest 20000  

            testCase "test for 30000" <| fun _ ->
                doBigTest 30000  

            testCase "test for 40000" <| fun _ ->
                doBigTest 40000 

            testCase "test for 50000" <| fun _ ->
                doBigTest 50000

            testCase "test for 60000" <| fun _ ->
                doBigTest 60000

            testCase "test for 70000" <| fun _ ->
                doBigTest 70000  

            testCase "test for 80000" <| fun _ ->
                doBigTest 80000  

            testCase "test for 90000" <| fun _ ->
                doBigTest 90000  
